...
else
{
    ...
    <input type="text" class="inputField" name="username" placeholder="Потребителско име ">
...
<table>
    ...
    <!-- AVATAR UPLOAD/SHOW -->
    	...
    	<td >
    <h4><big>Профил:</big> <font color="#10932c"><?php echo "".$employ['username']."";?></font></h4>
	<h4><big>Електронна поща:</big> <font color="#10932c"><?php echo "".$employ['email']."";;?></font></h4>
	<h4><big>Местожителство:</big> <font color="#10932c"> <?php echo "".$employ['area']."";;?></font></h4>
	...
	echo "<font color='red'>Извиняваме се, но <big><big>има проблем</big></big> с потребител <big><big>".$username."</big></big>!<br/>Моля, проверете отново дали сте го изписали правилно.</font>";
}
